        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(saleAttr,index) in skuSaleAttrValueList" :key="saleAttr.id">
...
import { mapGetters } from 'vuex';
  ...
  export default {
    ...
    methods: {
     ...
     async addShopCar(){
        try {
          let result = await this.$store.dispatch('detailOption/addOrUpdateShopInfo',{skuId:this.$route.params.skuId,skuNum:this.skuNum})
    ...
    mounted() {
      this.$store.dispatch('detailOption/DetailInfo',this.$route.params.skuId);
    },
    computed:{
      ...mapGetters('detailOption',['categoryView','skuInfo']),
      skuImageList(){
